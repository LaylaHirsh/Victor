...
// PREDICATES:
  ...
  static double getBondLengthTol() { return BOND_LENGTH_TOL; }
  static double getBondAngleTol() { return BOND_ANGLE_TOL; }
...
// MODIFIERS:
  ...
  static void setBondLengthTol(float t) { BOND_LENGTH_TOL = t; }
  static void setBondAngleTol(float t) { BOND_ANGLE_TOL = t; }
